...
<div id="xen-ai-widget"
	...
	<div id="xen-ai-window"
		...
		<div class="xen-ai-win-header">
			...
			<div class="xen-ai-win-header-actions">
				<!-- Pro: KB topic panel toggle — shown by JS when Pro active -->
				<button id="xen-ai-kb-toggle"
				        class="xen-ai-kb-toggle"
				        aria-label="<?php esc_attr_e( 'Browse knowledge topics', 'xen-ai' ); ?>"
				        aria-expanded="false"
				        title="<?php esc_attr_e( 'Browse topics', 'xen-ai' ); ?>"
				        style="display:none;">
		...
		<!-- Pro: Knowledge-base topic panel (toggled via header button, Pro only) -->
		<div id="xen-ai-kb-panel"
		     class="xen-ai-kb-panel"
		     role="region"
		     aria-label="<?php esc_attr_e( 'Knowledge base topics', 'xen-ai' ); ?>"
		     aria-hidden="true"
		     style="display:none;">
			<div class="xen-ai-kb-panel-header">
				<span class="xen-ai-kb-panel-title">📚 <?php esc_html_e( 'Topics', 'xen-ai' ); ?></span>
				<span id="xen-ai-kb-panel-subtitle" class="xen-ai-kb-panel-subtitle"><?php esc_html_e( 'All knowledge base topics', 'xen-ai' ); ?></span>
			</div>
			<div id="xen-ai-kb-list" class="xen-ai-kb-list"></div>
		</div>
